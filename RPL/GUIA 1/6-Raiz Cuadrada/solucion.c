...
A cada paso del algoritmo, l
a nueva estimación se calcula de la siguiente forma nueva_estimacion = (estimacion + x/estimacion) / 2.

Si PRECISION es una constante ya dada, 
...
que también es una constante designada, llamada ERROR.
*/
